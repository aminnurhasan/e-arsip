...
class KepalaBadanController extends Controller
{
    ...
    public function indexArsip()
    {
        ...
        return view ('user.kepala_badan.arsip.index', compact('arsip', 'suratMasuk', 'peraturan', 'apbd', 'keuangan', 'slide', 'dokumentasi', 'lainnya'));
    }
    ...
    public function peraturanIndex()
    {
        ...
        return view ('user.kepala_badan.arsip.peraturan.index', compact('peraturan', 'years'));
    }
    ...
    public function peraturanFilter(Request $request)
{
    ...
    public function apbdIndex()
    {
        ...
        return view ('user.kepala_badan.arsip.apbd.index', compact('apbd', 'years'));
    }
    ...
    public function keuanganIndex()
    {
        ...
        return view ('user.kepala_badan.arsip.keuangan.index', compact('keuangan', 'years'));
    }
    ...
    public function slideIndex()
    {
        ...
        return view ('user.kepala_badan.arsip.slide.index', compact('slide', 'years'));
    }
    ...
    public function lainnyaIndex()
    {
        ...
        return view ('user.kepala_badan.arsip.lainnya.index', compact('lainnya', 'years'));
    }
    ...
    public function suratMasukIndex()
    {
        ...
        $suratMasuk = Agenda::join('disposisi', 'agenda.id', '=', 'disposisi.agenda_id')
            ...
            ->get();
        return view ('user.kepala_badan.arsip.surat_masuk.index', compact('suratMasuk', 'years'));
    }
