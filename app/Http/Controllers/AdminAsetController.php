...
class AdminAsetController extends Controller
{
    ...
    {
        return view ('user.b_aset.admin.dashboard');
    }
    ...
    public function indexAgenda()
    {
        ...
        return view ('user.b_aset.admin.agenda.index', compact('agenda'));
    }

    public function createAgenda()
    {
        $agenda = Agenda::where('status', 1)->get();
        return view ('user.b_aset.admin.agenda.create', compact('agenda'));
    }
    ...
    public function storeAgenda(Request $request)
    {
        ...
        return redirect()->route('agendaAdminAset');
    }
    ...
    public function indexArsip()
    {
        ...
        return view ('user.b_aset.admin.arsip.index', compact('arsip', 'peraturan', 'apbd', 'keuangan', 'slide', 'dokumentasi', 'lainnya'));
    }

    public function createArsip()
    {
        $arsip = Arsip::all();
        return view ('user.b_aset.admin.arsip.create', compact('arsip'));
    }
    ...
    public function storeArsip(Request $request)
    {
        ...
        return redirect()->route('arsipAdminAset');
    }

    public function editArsip($id)
    {
        $arsip = Arsip::findOrFail($id);
        return view ('user.b_aset.admin.arsip.edit', compact('arsip'));
    }
    ...
    public function peraturanIndex()
    {
        ...
        return view ('user.b_aset.admin.arsip.peraturan.index', compact('peraturan'));
    }

    public function apbdIndex()
    {
        $apbd = Arsip::where('jenis_dokumen', 2)->get();
        return view ('user.b_aset.admin.arsip.apbd.index', compact('apbd'));
    }

    public function keuanganIndex()
    {
        $keuangan = Arsip::where('jenis_dokumen', 3)->get();
        return view ('user.b_aset.admin.arsip.keuangan.index', compact('keuangan'));
    }

    public function slideIndex()
    {
        $slide = Arsip::where('jenis_dokumen', 4)->get();
        return view ('user.b_aset.admin.arsip.slide.index', compact('slide'));
    }

    public function lainnyaIndex()
    {
        $lainnya = Arsip::where('jenis_dokumen', 5)->get();
        return view ('user.b_aset.admin.arsip.lainnya.index', compact('lainnya'));
    }
    // Arsip End
    ...
    public function indexDokumentasi()
    {
        ...
        $foto = Foto::all();
        return view ('user.b_aset.admin.dokumentasi.index', compact('dokumentasi', 'foto'));
    }

    public function createDokumentasi()
    {
        return view ('user.b_aset.admin.dokumentasi.create');
    }
    ...
    public function storeDokumentasi(Request $request)
    {
        ...
        return redirect()->route('dokumentasiAdminAset');
    }
    ...
    public function showDokumentasi($id)
    {
        ...
        return view ('user.b_aset.admin.dokumentasi.show', compact('dokumentasi', 'foto'));
    }

    public function editDokumentasi($id)
    {
        $dokumentasi = Dokumentasi::with('foto')->findOrFail($id);
        return view ('user.b_aset.admin.dokumentasi.edit', ['dokumentasi' => $dokumentasi]);
    }
    ...
    public function indexStaff()
    {
        ...
        return view ('user.b_aset.admin.staff.index', compact('staff'));
    }
    ...
    public function status($id)
    {
        ...
        if($statusGet == 0) {
            ...
            return redirect()->route('staffAdminAset');
        }else{
    ...
    {
        $staff = User::all();
        return view ('user.b_aset.admin.staff.create', compact('staff'));
    }
    ...
    public function editStaff($id)
    {
        $staff = User::findOrFail($id);
          ...
          return view ('user.b_aset.admin.staff.edit', compact('staff', 'roles'));
    }
