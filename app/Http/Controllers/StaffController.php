...
class StaffController extends Controller
{
    ...
    public function indexArsip()
    {
        ...
        return view ('user.staff.arsip.index', compact('arsip', 'suratMasuk', 'peraturan', 'apbd', 'keuangan', 'slide', 'dokumentasi', 'lainnya'));
    }
    ...
    public function peraturanIndex()
    {
        ...
        return view ('user.staff.arsip.peraturan.index', compact('peraturan', 'years'));
    }
    ...
    public function peraturanFilter(Request $request)
{
    ...
    public function apbdIndex()
    {
        ...
        return view ('user.staff.arsip.apbd.index', compact('apbd', 'years'));
    }
    ...
    public function keuanganIndex()
    {
        ...
        return view ('user.staff.arsip.keuangan.index', compact('keuangan', 'years'));
    }
    ...
    public function slideIndex()
    {
        ...
        return view ('user.staff.arsip.slide.index', compact('slide', 'years'));
    }
    ...
    public function lainnyaIndex()
    {
        ...
        return view ('user.staff.arsip.lainnya.index', compact('lainnya', 'years'));
    }
    ...
    public function suratMasukIndex()
    {
        ...
        $suratMasuk = Agenda::join('disposisi', 'agenda.id', '=', 'disposisi.agenda_id')
            ...
            ->get();
        return view ('user.staff.arsip.surat_masuk.index', compact('suratMasuk', 'years'));
    }
