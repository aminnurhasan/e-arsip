...
class KabidController extends Controller
{
    ...
    public function indexAgenda()
    {
        ...
        return view('user.kabid.agenda.index', compact('agenda', 'agendaSelesai'));
    }
    ...
    public function disposisiAgenda($id)
    {
        ...
        return view('user.kabid.agenda.disposisi', compact('agenda', 'disposisi'));
    }
    ...
    public function indexArsip()
    {
        ...
        return view ('user.kabid.arsip.index', compact('arsip', 'peraturan', 'apbd', 'keuangan', 'slide', 'dokumentasi', 'lainnya'));
    }
    ...
    public function peraturanIndex()
    {
        ...
        return view ('user.kabid.arsip.peraturan.index', compact('peraturan'));
    }

    public function apbdIndex()
    {
        $apbd = Arsip::where('jenis_dokumen', 2)->get();
        return view ('user.kabid.arsip.apbd.index', compact('apbd'));
    }

    public function keuanganIndex()
    {
        $keuangan = Arsip::where('jenis_dokumen', 3)->get();
        return view ('user.kabid.arsip.keuangan.index', compact('keuangan'));
    }

    public function slideIndex()
    {
        $slide = Arsip::where('jenis_dokumen', 4)->get();
        return view ('user.kabid.arsip.slide.index', compact('slide'));
    }

    public function lainnyaIndex()
    {
        $lainnya = Arsip::where('jenis_dokumen', 5)->get();
        return view ('user.kabid.arsip.lainnya.index', compact('lainnya'));
    }
    // Arsip End
