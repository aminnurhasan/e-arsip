...
class AdminController extends Controller
{
    ...
    public function indexArsip()
    {
        ...
        return view ('user.admin.arsip.index', compact('arsip', 'suratMasuk', 'peraturan', 'apbd', 'keuangan', 'slide', 'dokumentasi', 'lainnya'));
    }
    ...
    public function peraturanIndex()
    {
        ...
        return view ('user.admin.arsip.peraturan.index', compact('peraturan', 'years'));
    }
    ...
    public function peraturanFilter(Request $request)
{
    ...
    public function apbdIndex()
    {
        ...
        return view ('user.admin.arsip.apbd.index', compact('apbd', 'years'));
    }
    ...
    public function keuanganIndex()
    {
        ...
        return view ('user.admin.arsip.keuangan.index', compact('keuangan', 'years'));
    }
    ...
    public function slideIndex()
    {
        ...
        return view ('user.admin.arsip.slide.index', compact('slide', 'years'));
    }
    ...
    public function lainnyaIndex()
    {
        ...
        return view ('user.admin.arsip.lainnya.index', compact('lainnya', 'years'));
    }
    ...
    public function suratMasukIndex()
    {
        ...
        $suratMasuk = Agenda::join('disposisi', 'agenda.id', '=', 'disposisi.agenda_id')
            ...
            ->get();
        return view ('user.admin.arsip.surat_masuk.index', compact('suratMasuk', 'years'));
    }
