...
class SubbagUmumController extends Controller
{
    ...
    {
        return view ('user.sekretaris.subbag_umum.dashboard');
    }
    ...
    public function indexAgenda()
    {
        $agenda = DB::select(DB::raw('
            ...
            WHERE disposisi.disposisi = 10 AND disposisi.laporan IS NULL
        '));
        ...
        $agendaSelesai = DB::select(DB::raw('
            ...
            FROM disposisi
            JOIN agenda ON disposisi.agenda_id = agenda.id
            WHERE disposisi.disposisi = 10 AND disposisi.laporan IS NOT NULL
        '));

        return view('user.sekretaris.subbag_umum.agenda.index', compact('agenda', 'agendaSelesai'));
    }
    ...
    public function uploadLaporan($id)
    {
        ...
        return view('user.sekretaris.subbag_umum.agenda.uploadLaporan', compact('agenda', 'disposisi'));
    }
    ...
    public function storeLaporan(Request $request, $id)
    {
        ...
        return redirect()->route('agendaSubbagUmum');
    }
    ...
    public function disposisiAgenda($id)
    {
        ...
        return view('user.sekretaris.subbag_umum.agenda.disposisi', compact('agenda', 'disposisi'));
    }
    ...
    public function indexDisposisi()
    {
        $disposisi = DB::select(DB::raw('
            ...
            FROM disposisi
            JOIN agenda ON disposisi.agenda_id = agenda.id
            WHERE disposisi.dp2 = 10
            OR disposisi.dp3 = 10
        '));

        return view('user.sekretaris.subbag_umum.disposisi.index', compact('disposisi'));
    }
    // Disposisi End
    ...
    public function indexArsip()
    {
        ...
        return view ('user.sekretaris.subbag_umum.arsip.index', compact('arsip', 'peraturan', 'apbd', 'keuangan', 'slide', 'dokumentasi', 'lainnya'));
    }

    public function createArsip()
    {
        $arsip = Arsip::all();
        return view ('user.sekretaris.subbag_umum.arsip.create', compact('arsip'));
    }
    ...
    public function storeArsip(Request $request)
    {
        ...
        return redirect()->route('arsipSubbagUmum');
    }

    public function editArsip($id)
    {
        $arsip = Arsip::findOrFail($id);
        return view ('user.sekretaris.subbag_umum.arsip.edit', compact('arsip'));
    }
    ...
    public function peraturanIndex()
    {
        ...
        return view ('user.sekretaris.subbag_umum.arsip.peraturan.index', compact('peraturan'));
    }

    public function apbdIndex()
    {
        $apbd = Arsip::where('jenis_dokumen', 2)->get();
        return view ('user.sekretaris.subbag_umum.arsip.apbd.index', compact('apbd'));
    }

    public function keuanganIndex()
    {
        $keuangan = Arsip::where('jenis_dokumen', 3)->get();
        return view ('user.sekretaris.subbag_umum.arsip.keuangan.index', compact('keuangan'));
    }

    public function slideIndex()
    {
        $slide = Arsip::where('jenis_dokumen', 4)->get();
        return view ('user.sekretaris.subbag_umum.arsip.slide.index', compact('slide'));
    }

    public function lainnyaIndex()
    {
        $lainnya = Arsip::where('jenis_dokumen', 5)->get();
        return view ('user.sekretaris.subbag_umum.arsip.lainnya.index', compact('lainnya'));
    }
    // Arsip End
    ...
    public function indexDokumentasi()
    {
        ...
        $foto = Foto::all();
        return view ('user.sekretaris.subbag_umum.dokumentasi.index', compact('dokumentasi', 'foto'));
    }

    public function createDokumentasi()
    {
        $dokumentasi = Dokumentasi::all();
        return view ('user.sekretaris.subbag_umum.dokumentasi.create', compact('dokumentasi'));
    }
    ...
    public function showDokumentasi($id)
    {
        ...
        return view ('user.sekretaris.subbag_umum.dokumentasi.show', compact('dokumentasi', 'foto'));
    }

    public function editDokumentasi($id)
    {
        $dokumentasi = Dokumentasi::with('foto')->findOrFail($id);
        return view ('user.sekretaris.subbag_umum.dokumentasi.edit', ['dokumentasi' => $dokumentasi]);
    }
