...
class SubbidPenggunaanController extends Controller
{
    ...
    {
        return view ('user.b_aset.subbid_penggunaan.dashboard');
    }
    ...
    public function indexAgenda()
    {
        $agenda = DB::select(DB::raw('
            ...
            WHERE disposisi.disposisi = 18 AND disposisi.laporan IS NULL
        '));
        ...
        $agendaSelesai = DB::select(DB::raw('
            ...
            FROM disposisi
            JOIN agenda ON disposisi.agenda_id = agenda.id
            WHERE disposisi.disposisi = 18 AND disposisi.laporan IS NOT NULL
        '));

        return view('user.b_aset.subbid_penggunaan.agenda.index', compact('agenda', 'agendaSelesai'));
    }
    ...
    public function uploadLaporan($id)
    {
        ...
        return view('user.b_aset.subbid_penggunaan.agenda.uploadLaporan', compact('agenda', 'disposisi'));
    }
    ...
    public function storeLaporan(Request $request, $id)
    {
        ...
        return redirect()->route('agendaSubbidPenggunaan');
    }
    ...
    public function disposisiAgenda($id)
    {
        ...
        return view('user.b_aset.subbid_penggunaan.agenda.disposisi', compact('agenda', 'disposisi'));
    }
    ...
    public function indexDisposisi()
    {
        $disposisi = DB::select(DB::raw('
            ...
            FROM disposisi
            JOIN agenda ON disposisi.agenda_id = agenda.id
            WHERE disposisi.dp2 = 18
            OR disposisi.dp3 = 18
        '));

        return view('user.b_aset.subbid_penggunaan.disposisi.index', compact('disposisi'));
    }
    // Disposisi End
    ...
    public function indexArsip()
    {
        ...
        return view ('user.b_aset.subbid_penggunaan.arsip.index', compact('arsip', 'peraturan', 'apbd', 'keuangan', 'slide', 'dokumentasi', 'lainnya'));
    }

    public function createArsip()
    {
        $arsip = Arsip::all();
        return view ('user.b_aset.subbid_penggunaan.arsip.create', compact('arsip'));
    }
    ...
    public function storeArsip(Request $request)
    {
        ...
        return redirect()->route('arsipSubbidPenggunaan');
    }

    public function editArsip($id)
    {
        $arsip = Arsip::findOrFail($id);
        return view ('user.b_aset.subbid_penggunaan.arsip.edit', compact('arsip'));
    }
    ...
    public function peraturanIndex()
    {
        ...
        return view ('user.b_aset.subbid_penggunaan.arsip.peraturan.index', compact('peraturan'));
    }

    public function apbdIndex()
    {
        $apbd = Arsip::where('jenis_dokumen', 2)->get();
        return view ('user.b_aset.subbid_penggunaan.arsip.apbd.index', compact('apbd'));
    }

    public function keuanganIndex()
    {
        $keuangan = Arsip::where('jenis_dokumen', 3)->get();
        return view ('user.b_aset.subbid_penggunaan.arsip.keuangan.index', compact('keuangan'));
    }

    public function slideIndex()
    {
        $slide = Arsip::where('jenis_dokumen', 4)->get();
        return view ('user.b_aset.subbid_penggunaan.arsip.slide.index', compact('slide'));
    }

    public function lainnyaIndex()
    {
        $lainnya = Arsip::where('jenis_dokumen', 5)->get();
        return view ('user.b_aset.subbid_penggunaan.arsip.lainnya.index', compact('lainnya'));
    }
    // Arsip End
    ...
    public function indexDokumentasi()
    {
        ...
        $foto = Foto::all();
        return view ('user.b_aset.subbid_penggunaan.dokumentasi.index', compact('dokumentasi', 'foto'));
    }

    public function createDokumentasi()
    {
        $dokumentasi = Dokumentasi::all();
        return view ('user.b_aset.subbid_penggunaan.dokumentasi.create', compact('dokumentasi'));
    }
    ...
    public function storeDokumentasi(Request $request)
    {
        ...
        return redirect()->route('dokumentasiSubbidPenggunaan');
    }
    ...
    public function showDokumentasi($id)
    {
        ...
        return view ('user.b_aset.subbid_penggunaan.dokumentasi.show', compact('dokumentasi', 'foto'));
    }

    public function editDokumentasi($id)
    {
        $dokumentasi = Dokumentasi::with('foto')->findOrFail($id);
        return view ('user.b_aset.subbid_penggunaan.dokumentasi.edit', ['dokumentasi' => $dokumentasi]);
    }
