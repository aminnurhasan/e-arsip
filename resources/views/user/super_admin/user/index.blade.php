                                ...
                                @foreach ($user as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($item->status == 0)
                                                <a href="{{ route('statusUserSuperAdmin', $item->id) }}" type="button" class="btn btn-danger">Non-aktif</a>
                                            @else
                                                <a href="{{ route('statusUserSuperAdmin', $item->id) }}" type="button" class="btn btn-success">Aktif</a>
                                            @endif
                                        </td>
                                        <td>
