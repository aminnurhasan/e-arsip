...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Data Arsip (Laporan Keuangan)</h1>
            </div>            
        </div>
    </div>
</div>
        ...
        <div class="row">
            <section class="col-lg-12">
                <div class="d-flex justify-content-between">
                    <a href="{{ route('arsipStaff') }}" class="btn btn-md btn-info mb-2">Kembali</a>
...
<script>
    ...
    function updateTable(data) {
        ...
        data.forEach(function(item) {
            ...
            row += '<a href="/staff/arsip/' + item.id + '/edit" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>';
            row += '</td>';
