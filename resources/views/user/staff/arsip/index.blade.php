    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipStaff')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/staff/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanStaff')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdStaff')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganStaff')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideStaff')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaStaff')}}";
    }
</script>
@endsection