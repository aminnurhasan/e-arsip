                                ...
                                @foreach ($agenda as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="{{url('/b_perbendaharaan/laporan/' . $item->id . '/upload')}}" class="btn btn-primary btn-sm ">Upload</a>
                                        </td>
                                        <td style="text-align: center">
                                            <a href="{{url('/b_perbendaharaan/agenda/' . $item->id . '/disposisi')}}" class="btn btn-success btn-sm ">Disposisikan</a>
                                        </td>
                                        <td style="text-align: center">
