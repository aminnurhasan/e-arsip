@extends('user.b_perbendaharaan.subbid_pengelolaan.layouts.app')
    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbidPengelolaan')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbid_pengelolaan/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbidPengelolaan')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbidPengelolaan')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbidPengelolaan')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbidPengelolaan')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbidPengelolaan')}}";
    }
</script>
@endsection