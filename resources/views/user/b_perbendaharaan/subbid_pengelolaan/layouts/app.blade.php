...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.b_perbendaharaan.subbid_pengelolaan.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.b_perbendaharaan.subbid_pengelolaan.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.b_perbendaharaan.subbid_pengelolaan.layouts.footer')
</div>
<!-- ./wrapper -->
