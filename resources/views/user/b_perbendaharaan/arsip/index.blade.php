@extends('user.b_perbendaharaan.layouts.app')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <section class="col-lg-12">
                ...
                <a href="{{route('createArsipBidangPerbendaharaan')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/b_perbendaharaan/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanBidangPerbendaharaan')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdBidangPerbendaharaan')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganBidangPerbendaharaan')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideBidangPerbendaharaan')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaBidangPerbendaharaan')}}";
    }
</script>
@endsection