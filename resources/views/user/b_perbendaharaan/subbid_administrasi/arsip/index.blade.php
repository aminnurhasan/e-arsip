    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbidAdministrasi')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbid_administrasi/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbidAdministrasi')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbidAdministrasi')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbidAdministrasi')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbidAdministrasi')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbidAdministrasi')}}";
    }
</script>
@endsection