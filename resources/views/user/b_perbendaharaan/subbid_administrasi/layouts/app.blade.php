...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.b_perbendaharaan.subbid_administrasi.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.b_perbendaharaan.subbid_administrasi.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.b_perbendaharaan.subbid_administrasi.layouts.footer')
</div>
<!-- ./wrapper -->
