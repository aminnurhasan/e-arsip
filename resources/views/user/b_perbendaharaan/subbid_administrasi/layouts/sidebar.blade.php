<aside class="main-sidebar sidebar-light-secondary elevation-4" style="background-color: lightgray; position: fixed">
    <a href="{{route('dashboardSubbidAdministrasi')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_administrasi/dashboard')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_administrasi/agenda')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_administrasi/disposisi')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_administrasi/arsip')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_administrasi/dokumentasi')}}" class="nav-link d-block">
