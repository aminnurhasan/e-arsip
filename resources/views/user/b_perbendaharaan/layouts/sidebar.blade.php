<aside class="main-sidebar sidebar-light-secondary elevation-4" style="background-color: lightgray; position: fixed">
    <a href="{{route('dashboardBidangPerbendaharaan')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/b_perbendaharaan/dashboard')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/b_perbendaharaan/agenda')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/b_perbendaharaan/disposisi')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/b_perbendaharaan/arsip')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/b_perbendaharaan/dokumentasi')}}" class="nav-link d-block">
