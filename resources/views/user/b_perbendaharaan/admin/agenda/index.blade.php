    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createAgendaAdminPerbendaharaan')}}" class="btn btn-md btn-info mb-2">Tambah Data Agenda</a>
                                ...
                                @foreach ($agenda as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            action="{{ url('admin_perbendaharaan/agenda/' . $item->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
