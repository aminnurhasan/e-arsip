    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipAdminPerbendaharaan')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/admin_perbendaharaan/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanAdminPerbendaharaan')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdAdminPerbendaharaan')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganAdminPerbendaharaan')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideAdminPerbendaharaan')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaAdminPerbendaharaan')}}";
    }
</script>
@endsection