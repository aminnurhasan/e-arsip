...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.b_perbendaharaan.admin.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.b_perbendaharaan.admin.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.b_perbendaharaan.admin.layouts.footer')
</div>
<!-- ./wrapper -->
