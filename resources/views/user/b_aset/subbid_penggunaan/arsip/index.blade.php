    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbidPenggunaan')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbid_penggunaan/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbidPenggunaan')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbidPenggunaan')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbidPenggunaan')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbidPenggunaan')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbidPenggunaan')}}";
    }
</script>
@endsection