...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.b_aset.subbid_penggunaan.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.b_aset.subbid_penggunaan.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.b_aset.subbid_penggunaan.layouts.footer')
</div>
<!-- ./wrapper -->
