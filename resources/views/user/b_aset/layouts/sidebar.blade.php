<aside class="main-sidebar sidebar-light-secondary elevation-4" style="background-color: lightgray; position: fixed">
    <a href="{{route('dashboardBidangAset')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/b_aset/dashboard')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/b_aset/agenda')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/b_aset/disposisi')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/b_aset/arsip')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/b_aset/dokumentasi')}}" class="nav-link d-block">
