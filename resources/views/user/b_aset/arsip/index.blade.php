    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <section class="col-lg-12">
                ...
                <a href="{{route('createArsipBidangAset')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/b_aset/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanBidangAset')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdBidangAset')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganBidangAset')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideBidangAset')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaBidangAset')}}";
    }
</script>
@endsection