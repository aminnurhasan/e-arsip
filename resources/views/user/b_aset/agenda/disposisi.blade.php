            ...
            <section class="col-lg-12">
                ...
                <div class="card">  
                    <div class="card-body">
                        ...
                        <form action="{{ route('updateDisposisiAgendaBidangAset', $agenda->id) }}" method="post" enctype="multipart/form-data">
                            @csrf @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="disposisi" id="" class="form-control">
                                        ...
                                        <option value="17">SubBid Perencanaan dan Penatausahaan</option>
                                        <option value="18">SubBid Penggunaan dan Pemanfaatan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
