...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.b_aset.subbid_perencanaan.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.b_aset.subbid_perencanaan.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.b_aset.subbid_perencanaan.layouts.footer')
</div>
<!-- ./wrapper -->
