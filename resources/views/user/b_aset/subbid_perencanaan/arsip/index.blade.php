    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbidPerencanaan')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbid_perencanaan/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbidPerencanaan')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbidPerencanaan')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbidPerencanaan')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbidPerencanaan')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbidPerencanaan')}}";
    }
</script>
@endsection