    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbid')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                <div class="card">
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbid')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbid')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbid')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbid')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbid')}}";
    }
    function redirectSuratMasuk() {
        window.location.href = "{{route('suratMasukSubbid')}}";
    }
</script>
@endsection