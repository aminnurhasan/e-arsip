<aside class="main-sidebar sidebar-light-secondary elevation-4" style="background-color: lightgray; position: fixed">
    <a href="{{route('dashboardSubbid')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" style="overflow-x: hidden">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid/dashboard')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/subbid/agenda')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Agenda Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/subbid/agenda/saya')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Agenda Saya</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{url('/subbid/disposisi')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid/arsip')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid/dokumentasi')}}" class="nav-link d-block">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid/gantipassword')}}" class="nav-link">
