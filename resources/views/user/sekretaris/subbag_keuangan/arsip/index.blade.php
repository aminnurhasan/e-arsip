    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbagKeuangan')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbag_keuangan/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbagKeuangan')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbagKeuangan')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbagKeuangan')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbagKeuangan')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbagKeuangan')}}";
    }
</script>
@endsection