...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.sekretaris.subbag_keuangan.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.sekretaris.subbag_keuangan.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.sekretaris.subbag_keuangan.layouts.footer')
</div>
<!-- ./wrapper -->
