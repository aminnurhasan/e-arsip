    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                ...
                <a href="{{ route('selesaikanAgendaSekretaris', $disposisi->id) }}" class="btn btn-md btn-success mb-2">Selesaikan</a>
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('storeTindakLanjutSekretaris', $agenda->id) }}" method="post" enctype="multipart/form-data">
                            @csrf @method('PUT')
                            ...
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    <select name="disposisi" id="" class="form-control">
                                        ...
                                        <option value="8">SubBag Perencanaan & Evaluasi</option>
                                        <option value="9">SubBag Keuangan</option>
                                        <option value="10">SubBag Umum & Kepegawaian</option>
                                    </select>
                                </div>
                                <div class="col-6">
