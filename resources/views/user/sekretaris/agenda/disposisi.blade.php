    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                ...
                <div class="card">  
                    <div class="card-body">
                        <form action="{{ route('updateDisposisiAgendaSekretaris', $agenda->id) }}" method="post" enctype="multipart/form-data">
                            @csrf @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="disposisi" id="" class="form-control">
                                        ...
                                        <option value="8">SubBag Perencanaan dan Evaluasi</option>
                                        <option value="9">SubBag Keuangan</option>
                                        <option value="10">SubBag Umum dan Kepegawaian</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
