    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{ route('dokumentasiAdminSekretaris') }}" class="btn btn-md btn-info mb-2">Kembali</a>

                <div class="card">
                    <div class="card-body">

                        <form action="{{route('updateDokumentasiAdminSekretaris', $dokumentasi->id)}}" method="post" enctype="multipart/form-data">
                            @csrf @method('PUT')
