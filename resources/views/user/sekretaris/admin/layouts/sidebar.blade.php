<aside class="main-sidebar sidebar-light-secondary elevation-4" style="background-color: lightgray; position: fixed">
    <a href="{{route('dashboardAdminSekretaris')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/admin_sekretaris/staff')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/admin_sekretaris/agenda')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/admin_sekretaris/arsip')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/admin_sekretaris/dokumentasi')}}" class="nav-link d-block">
