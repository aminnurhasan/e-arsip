    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipAdminSekretaris')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanAdminSekretaris')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdAdminSekretaris')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganAdminSekretaris')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideAdminSekretaris')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaAdminSekretaris')}}";
    }
</script>
@endsection