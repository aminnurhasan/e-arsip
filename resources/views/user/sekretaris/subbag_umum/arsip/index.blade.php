    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbagUmum')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbag_umum/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbagUmum')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbagUmum')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbagUmum')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbagUmum')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbagUmum')}}";
    }
</script>
@endsection