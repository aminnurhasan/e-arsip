<aside class="main-sidebar sidebar-light-secondary elevation-4" style="background-color: lightgray; position: fixed">
    <a href="{{route('dashboardSubbagUmum')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/subbag_umum/dashboard')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbag_umum/agenda')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbag_umum/disposisi')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbag_umum/arsip')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbag_umum/dokumentasi')}}" class="nav-link d-block">
