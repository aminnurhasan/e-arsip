...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.sekretaris.subbag_umum.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.sekretaris.subbag_umum.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.sekretaris.subbag_umum.layouts.footer')
</div>
<!-- ./wrapper -->
