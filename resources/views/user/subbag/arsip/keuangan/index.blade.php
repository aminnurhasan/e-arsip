        ...
        <div class="row">
            <section class="col-lg-12">
                <div class="d-flex justify-content-between">
                    <a href="{{ route('arsipSubbag') }}" class="btn btn-md btn-info mb-2">Kembali</a>
...
<script>
    ...
    function updateTable(data) {
        ...
        data.forEach(function(item) {
            ...
            row += '<a href="/subbag/arsip/' + item.id + '/edit" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>';
            row += '</td>';
