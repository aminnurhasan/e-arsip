    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbag')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                <div class="card">
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbag')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbag')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbag')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbag')}}";
    }
