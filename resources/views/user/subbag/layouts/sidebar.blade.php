<aside class="main-sidebar sidebar-light-secondary elevation-4" style="background-color: lightgray; position: fixed">
    <a href="{{route('dashboardSubbag')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/subbag/dashboard')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/subbag/agenda')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Agenda Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/subbag/agenda/saya')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Agenda Saya</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{url('/subbag/disposisi')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbag/arsip')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbag/dokumentasi')}}" class="nav-link d-block">
          ...
          <li class="nav-item">
            <a href="{{url('/subbag/gantipassword')}}" class="nav-link">
