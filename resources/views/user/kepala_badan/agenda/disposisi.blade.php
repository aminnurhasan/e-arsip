            ...
            <section class="col-lg-12">
                ...
                <div class="card">  
                    <div class="card-body">
                        ...
                        <form action="{{ route('updateDisposisiAgendaKepalaBadan', $agenda->id) }}" method="post" enctype="multipart/form-data">
                            @csrf @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="catatan" id="" cols="30" rows="2" class="form-control"></textarea>
                            </div>                           
