    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbidVerifikasi')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbid_verifikasi/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbidVerifikasi')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbidVerifikasi')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbidVerifikasi')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbidVerifikasi')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbidVerifikasi')}}";
    }
</script>
@endsection