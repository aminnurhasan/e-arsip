...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.b_akuntansi.subbid_verifikasi.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.b_akuntansi.subbid_verifikasi.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.b_akuntansi.subbid_verifikasi.layouts.footer')
</div>
<!-- ./wrapper -->
