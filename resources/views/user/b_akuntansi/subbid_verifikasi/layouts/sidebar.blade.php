<aside class="main-sidebar sidebar-light-secondary elevation-4" style="background-color: lightgray; position: fixed">
    <a href="{{route('dashboardSubbidVerifikasi')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_verifikasi/dashboard')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_verifikasi/agenda')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_verifikasi/disposisi')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_verifikasi/arsip')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/subbid_verifikasi/dokumentasi')}}" class="nav-link d-block">
