@extends('user.b_akuntansi.layouts.app')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <section class="col-lg-12">
                ...
                <a href="{{route('createArsipBidangAkuntansi')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/b_akuntansi/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanBidangAkuntansi')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdBidangAkuntansi')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganBidangAkuntansi')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideBidangAkuntansi')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaBidangAkuntansi')}}";
    }
</script>
@endsection