...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.b_akuntansi.subbid_pembukuan.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.b_akuntansi.subbid_pembukuan.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.b_akuntansi.subbid_pembukuan.layouts.footer')
</div>
<!-- ./wrapper -->
