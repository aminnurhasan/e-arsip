    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbidPembukuan')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbid_pembukuan/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbidPembukuan')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbidPembukuan')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbidPembukuan')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbidPembukuan')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbidPembukuan')}}";
    }
</script>
@endsection