    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{ route('createStaffAdminAkuntansi') }}" class="btn btn-md btn-info mb-2">Tambah Data Staff</a>
                            ...
                            <tbody>
                                @foreach ($staff as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href='{{ url('/admin_akuntansi/staff/' . $item->id . '/edit') }}' class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
