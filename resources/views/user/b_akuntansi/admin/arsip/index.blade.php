    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipAdminAkuntansi')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/admin_akuntansi/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanAdminAkuntansi')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdAdminAkuntansi')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganAdminAkuntansi')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideAdminAkuntansi')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaAdminAkuntansi')}}";
    }
</script>
@endsection