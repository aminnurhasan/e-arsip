<aside class="main-sidebar sidebar-light-secondary elevation-4" style="background-color: lightgray; position: fixed">
    <a href="{{route('dashboardAdminAkuntansi')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/admin_akuntansi/staff')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/admin_akuntansi/agenda')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/admin_akuntansi/arsip')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/admin_akuntansi/dokumentasi')}}" class="nav-link d-block">
