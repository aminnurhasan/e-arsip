            ...
            <section class="col-lg-12">
                ...
                <div class="card">  
                    <div class="card-body">
                        ...
                        <form action="{{ route('updateDisposisiAgendaBidangAkuntansi', $agenda->id) }}" method="post" enctype="multipart/form-data">
                            @csrf @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="disposisi" id="" class="form-control">
                                        ...
                                        <option value="15">SubBid Pembukuan dan Pelaporan</option>
