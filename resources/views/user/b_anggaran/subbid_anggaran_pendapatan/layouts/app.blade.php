...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.b_anggaran.subbid_anggaran_pendapatan.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.b_anggaran.subbid_anggaran_pendapatan.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.b_anggaran.subbid_anggaran_pendapatan.layouts.footer')
</div>
<!-- ./wrapper -->
