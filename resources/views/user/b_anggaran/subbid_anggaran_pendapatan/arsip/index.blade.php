@extends('user.b_anggaran.subbid_anggaran_pendapatan.layouts.app')
    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbidAnggaranPendapatan')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbid_anggaran_pendapatan/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbidAnggaranPendapatan')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbidAnggaranPendapatan')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbidAnggaranPendapatan')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbidAnggaranPendapatan')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbidAnggaranPendapatan')}}";
    }
</script>
@endsection