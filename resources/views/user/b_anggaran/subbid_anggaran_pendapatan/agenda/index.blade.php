                                ...
                                @foreach ($agenda as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="{{url('/subbid_anggaran_pendapatan/laporan/' . $item->id . '/upload')}}" class="btn btn-primary btn-sm ">Upload</a>
                                        </td>
                                        <td style="text-align: center">
                                            <a href="{{url('/subbid_anggaran_pendapatan/agenda/' . $item->id . '/disposisi')}}" class="btn btn-success btn-sm ">Disposisikan</a>
                                        </td>
                                        <td style="text-align: center">
