...
<div class="wrapper">  
  <!-- Navbar -->
  @include('user.b_anggaran.subbid_anggaran_belanja.layouts.navbar')
  <!-- /.navbar -->

  <!-- Sidebar -->
  @include('user.b_anggaran.subbid_anggaran_belanja.layouts.sidebar')
  ...
  <!-- Main Footer -->
  @include('user.b_anggaran.subbid_anggaran_belanja.layouts.footer')
</div>
<!-- ./wrapper -->
