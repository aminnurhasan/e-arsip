@extends('user.b_anggaran.subbid_anggaran_belanja.layouts.app')
    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipSubbidAnggaranBelanja')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                                ...
                                @foreach ($arsip as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/subbid_anggaran_belanja/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanSubbidAnggaranBelanja')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdSubbidAnggaranBelanja')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganSubbidAnggaranBelanja')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideSubbidAnggaranBelanja')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaSubbidAnggaranBelanja')}}";
    }
</script>
@endsection