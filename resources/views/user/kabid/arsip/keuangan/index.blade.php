        ...
        <div class="row">
            <section class="col-lg-12">
                <div class="d-flex justify-content-between">
                    <a href="{{ route('arsipKabid') }}" class="btn btn-md btn-info mb-2">Kembali</a>
                                ...
                                @foreach ($keuangan as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{url('/kabid/arsip/' . $item->id . '/edit')}}" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    ...
    function updateTable(data) {
        ...
        data.forEach(function(item) {
            ...
            row += '<a href="/kabid/arsip/' + item.id + '/edit" class="btn btn-warning btn-sm fas fa-pen-to-square"></a>';
            row += '</td>';
