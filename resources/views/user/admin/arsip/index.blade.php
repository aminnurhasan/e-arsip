    ...
    <div class="container-fluid">
        <div class="row">
            <section class="col-lg-12">
                <a href="{{route('createArsipAdmin')}}" class="btn btn-md btn-info mb-2">Tambah Data Arsip</a>
                <div class="card">
...
<script>
    function redirectPeraturan() {
        window.location.href = "{{route('peraturanAdmin')}}";
    }
    function redirectAPBD() {
        window.location.href = "{{route('apbdAdmin')}}";
    }
    function redirectKeuangan() {
        window.location.href = "{{route('keuanganAdmin')}}";
    }
    function redirectSlide() {
        window.location.href = "{{route('slideAdmin')}}";
    }
    function redirectLainnya() {
        window.location.href = "{{route('lainnyaAdmin')}}";
    }
    function redirectSuratMasuk() {
        window.location.href = "{{route('suratMasukAdmin')}}";
    }
</script>
@endsection